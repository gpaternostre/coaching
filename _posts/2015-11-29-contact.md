...
<style type='text/css'> div.vcard { background-color: #2e3436; border-radius: 10px 10px 10px 10px; color: white; padding: 10px 10px; width: 310px; line-height: 1.2em; } div.vcard a{ color: white;} div.vcard div.fn{ font-weight: bold; border-bottom: 1px solid white; } div.vcard div.spacer{ min-height: 0.5em; } div.website{color: lightblue} #hcard_embed{max-width: 330px; display: inline-block;}</style>
